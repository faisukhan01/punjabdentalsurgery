    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        {statsRow.map((s) => (
          <div
            key={s.label}
            className="flex items-center gap-3.5 rounded-3xl border border-border/60 bg-card p-4 shadow-[0_8px_30px_rgb(18,88,143,0.06)]"
          >
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
          {DEVICES.map((device) => {
            ...
            return (
              <div
                key={device.key}
                className="flex items-center gap-4 rounded-3xl border border-border/60 bg-card p-5 shadow-[0_8px_30px_rgb(18,88,143,0.06)]"
              >
