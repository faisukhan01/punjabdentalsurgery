    ...
    <div className="flex flex-col gap-5">
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  active
                    ? "border-primary bg-primary text-primary-foreground shadow-[0_6px_18px_rgb(13,148,136,0.3)]"
      ...
      {loading && !data ? (
        ...
        <>
          ...
          {/* Desktop: table */}
          <div className="hidden overflow-hidden rounded-3xl border border-border/60 bg-card shadow-[0_8px_30px_rgb(13,148,136,0.06)] md:block">
            <Table>
              <TableHeader>
...
function AppointmentCard({ appt, busy, onStatus, onDelete }: AppointmentCardProps) {
  ...
  return (
    <div className="rounded-3xl border border-border/60 bg-card p-4 shadow-[0_8px_30px_rgb(13,148,136,0.06)]">
