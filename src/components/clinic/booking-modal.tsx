...
export function BookingModal() {
  ...
  const slotButtonClass = (s: string) => {
    ...
    if (selected)
      return "border-primary bg-primary text-primary-foreground shadow-[0_6px_18px_rgb(13,148,136,0.35)]";
          ...
          <AnimatePresence mode="wait" custom={dir} initial={false}>
                    ...
                    return (
                      <button
                        ...
                        className={`flex min-h-[44px] items-center gap-2 rounded-2xl border px-3.5 py-2.5 text-left text-[13px] font-medium leading-snug transition-all ${
                          selected
                            ? "border-primary bg-secondary text-primary shadow-[0_6px_18px_rgb(13,148,136,0.18)]"
            ...
            {step === 3 && (
              ...
              >
                ...
                <Button
                  className="mt-1 h-12 rounded-full text-[15px] font-semibold shadow-[0_10px_28px_rgb(13,148,136,0.35)]"
                  disabled={submitting}
                  onClick={() => void submit()}
                >
                  {submitting ? (
